            ...
            <div class="search-form wow pulse">
                <form action="{{ route('property') }}" method="GET" class=" form-inline">
                    <div class="col-md-12">
                        ...
                        <div class="col-md-4">
                            <select id="launchBegins" name="area_id[]" class="selectpicker" data-live-search="true" data-live-search-style="begins" title="Select your area" multiple>
                        ...
                        <div class="col-md-4">
                            <select id="launchBegins" name="category_id[]" class="selectpicker" title="Select Category" multiple>
                    ...
                    <div class="col-md-12 ">
                        <div class="search-row">
                            ...
                            <div class="col-sm-3">
                                ...
                                <b class="pull-left color">5000000₹</b>
                            ...
                            <div class="col-sm-3">
                                ...
                                <input type="text" class="span2" name="bathrooms" value="" data-slider-min="0"
                                       ...
                                       data-slider-value="[1,6]" id="property-geo" ><br />
                                <b class="pull-left color">1</b>
                        ...
                        <div class="search-row">
                            ...
                            <div class="col-sm-3">
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="amenities[]" value="{{ $id }}"> {{ $name }}
                                    </label>
                                </div>
                            </div>
                            @endforeach
    ...
    <div class="container">
        ...
        <div class="row">
            <div class="proerty-th">
                @foreach (App\Models\Property::orderByDesc('created_at')->limit(4)->get() as $property)
